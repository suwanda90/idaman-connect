...
namespace Web.Services
{
    ...
    public class IdamanService : IIdamanService
    {
        ...
        )
        {
            ...
            var token = BaseApiHelper.GetTokenIdaman(_clientLogin, model, _httpContextAccessor, _appSettings);

            _clientApi = new HttpClient
            {
                BaseAddress = new Uri(_config["Idaman:UrlApi"])
            };
        ...
        public async Task<BaseApiResultViewModel<UserIdamanViewModel>> GetUsersAsync()
        {
            ...
            {
                var response = await _clientApi.GetAsync("Users/" + email);
                var result = new BaseApiResultViewModel<UserIdamanViewModel>
                {
        ...
        {
            var response = await _clientApi.GetAsync("Applications/MyApps?userId=" + userIdamanId);
        ...
        {
            var response = await _clientApi.GetAsync("Applications/Roles/" + applicationId);
        ...
        {
            var response = await _clientApi.GetAsync("Users/Whitelist/" + userIdamanId);
        ...
        {
            var response = await _clientApi.GetAsync("Users/Whitelist/Detail/" + whitelistId);
        ...
        {
            var response = await _clientApi.GetAsync("Users/" + username);
            var result = new BaseApiResultViewModel<UserIdamanViewModel>
            {
                Data = new UserIdamanViewModel(),
                StatusCode = (int)response.StatusCode,
